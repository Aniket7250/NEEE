...
public class ApplicationFormSummaryTest extends TestBase {
	...
	//Dataprovider method --> return object array
			...
			@Test(dataProvider = "App", enabled=true, priority=1)
			public void TestDefa(Object obj1) throws Throwable {
...
//				MyLogger.startTestCase(new Throwable().getStackTrace()[0].getMethodName());
				...
				appFormSummaryPage.VerifyPropertyAddressDetails(testData);
				appFormSummaryPage.VerifyPropertyAddressCoveragesDetails(testData);
				//appFormSummaryPage.ValidatePolicyHistoryAndInspections(testData);
				appFormSummaryPage.AllButtonsEnabledOnScreen();
				appFormSummaryPage.ValidateUWrules(testData);
				appFormSummaryPage.validateSummaryScreenURL(testData);
